                        ...
                        <div className='read-more-message'>  
                            <div className="row justify-content-center criteria">
                                <div className="col-md-4 criteria-heading">
                                    <h2 className="criteria-subtitle">Counseling Criteria</h2>
                                </div>
                            ...
                            <div className="row justify-content-center criteria">
                                <div className="col-md-4 criteria-heading">
                                    <h2 className="criteria-subtitle">Application Template</h2>
                                </div>
                                <div className="col-md-8 criteria-content">
                            ...
                            <div className="row justify-content-center criteria">
                                <div className="col-md-4 criteria-heading">
                                    <h2 className="criteria-subtitle">After Submission</h2>
                                </div>
                                <div className="col-md-8 criteria-content">
                            ...
                            <div className="row justify-content-center criteria">
                                <div className="col-md-4 criteria-heading">
                                    <h2 className="criteria-subtitle">Important Deadlines</h2>
                                </div>
                                <div className="col-md-8 criteria-content">
