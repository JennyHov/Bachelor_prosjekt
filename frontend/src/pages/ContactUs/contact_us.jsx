        ...
        <div className="col-lg-6 submit-application-container">
          ...
          <form action="https://api.web3forms.com/submit" method="POST" className='form-container'>
            <div className='form-group form-box'>
              ...
              <input type="email" className="form-control text-muted form-input" name="ouremail" value="kontakt@sefio.no" readOnly />
            </div>

            <div className='form-group form-box'>
              <label htmlFor="email" className="form-label">Your Email</label>
              <input type="email" className="form-control form-input" name="email" placeholder="Type in your email" />
            </div>
              
            <div className='form-group form-box'>
              <label htmlFor="name" className="form-label">Name</label>
              <input className="form-control form-input" name="name" placeholder="Type in your name" />
            </div>
            
            <div className='form-group form-box'>
              <label htmlFor="projectName" className="form-label">Subject</label>
              <input type="text" className="form-control form-input" name="subject" placeholder="Subject for your inquiry" />
            </div>
            
            <div className='form-group form-box'>
              <label htmlFor="comments" className="form-label">Comments</label>
              <textarea className="form-control form-input" name="comments" rows="3" placeholder="Write your text here"></textarea>
            </div>
          </form>
