...
export default function PopupCollabForm() {
    ...
    return (
        <div>
          ...
          <Modal show={showForm} onHide={handleCloseForm} dialogClassName="modal-dialog-centered" role="dialog" aria-labelledby="modalTitle" aria-describedby="modalDescription">
            <Modal.Header closeButton>
              <Modal.Title id="modalTitle">Create a Profile</Modal.Title>
            </Modal.Header>
                <Modal.Body>
